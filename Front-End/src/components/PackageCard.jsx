...
const PackageCard = ({
  ...
  const handleBuyNow = () => {
    ...
    onSelectPackage(
      ...
      true
    ); // true indicates proceed to checkout
  };
  ...
  const handleSelectPackage = () => {
    onSelectPackage(
      ...
      false
    ); // false indicates just selection, no checkout
  };
  ...
  return (
    <div
      ...
      } overflow-hidden bg-white dark:bg-gray-800 transition-all hover:shadow-md flex flex-col h-full`}
    >
      {/* Selected badge */}
      {isSelected && (
      ...
      <div className="px-6 pt-6 pb-6 flex flex-col flex-grow">
        ...
        <div className="mt-auto pt-4">
          ...
          <div
            className={`${
              isSelected ? "grid grid-cols-1" : "grid grid-cols-1"
            } gap-3`}
          >
            {!isSelected ? (
              <button
