        ...
        <header ref={headerRef}
            ...
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 xl:px-8">
                ...
                <div className="hidden xl:flex xl:flex-1 xl:justify-end xl:items-center xl:space-x-4">
                    ...
                    <Popover className="relative group">
                        {({open}) => (
                            <>
                                {isLoggedIn ? (
                                    <PopoverButton
                                        className="flex items-center gap-x-1 text-sm/6 font-semibold text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-700 hover:border-primary hover:text-primary dark:hover:text-primary dark:hover:border-primary px-4 py-2 rounded-md transition-colors">
                                                ...
                                                isAdmin ? (
                                                    <>
                                                        ...
                                                        {adminOptions.map((option) => (
                                                            ...
                                                            >
                                                                <div
                                                                    className="flex size-10 flex-none items-center justify-center rounded-lg bg-gray-50 dark:bg-gray-900 group-hover:bg-white dark:group-hover:bg-gray-800">
                                                                    <option.icon
                    ...
                    <button
                        onClick={() => navigate("/user/dashboard?section=add-new-ad")}
                        className="relative overflow-hidden group bg-primary hover:bg-primary/90 border border-primary dark:border-primary hover:border-primary text-white dark:hover:border-primary/90 px-6 py-2 rounded-md flex items-center"
                    >
                        <span className="relative z-10 flex items-center font-medium">
                            Post Your Ad
