...
const UpdateAdvertisement = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const [categoriesRes, adRes] = await Promise.all([
                    getAllCategories(),
                ...
                setFeaturedImagePreview(adRes.featuredImage);
                setImagesPreviews(adRes.images || []);
            } catch (err) {
    ...
    useEffect(() => {
        ...
        if (ad.categoryId) {
            ...
            setAd(prev => ({ ...prev, NewSubcategoryId: '' }));
        }
    ...
    const handleImagesChange = (e) => {
        ...
        const combinedFiles = [...ad.images, ...newFiles];
    ...
    const handleSubmit = async (e) => {
        ...
        if (!ad.title || !ad.description || !ad.price || !ad.location || !ad.categoryId || !ad.subcategoryId) {
    ...
    return (
        <div className="bg-white dark:bg-gray-900 py-12 md:py-16 lg:py-20">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6 border-b pb-3">Update Advertisement</h2>
                {error && (
