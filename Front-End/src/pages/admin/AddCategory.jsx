...
const AddCategory = () => {
    ...
    const handleImageChange = (e) => {
        ...
        if (file) {
            ...
            if (!file.type.startsWith('image/')) {
                setError('Image must be an image file (JPEG, PNG, etc.)');
                return;
            }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            console.log("name= ",category.name, " sub= " , JSON.stringify(cleanedSubcategories), " image= " ,category.categoryImage)
            const response = await createCategory(formData, token);
            console.log('Category created:', response);
            setSuccess('Category has been created successfully!');
    ...
    return (
        <div className="bg-white dark:bg-gray-900 py-12 md:py-16 lg:py-20">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6 border-b pb-3">Create New Category</h2>
